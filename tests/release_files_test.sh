...
assert_contains "$ROOT/README.md" "ADTENTION_REF"
assert_contains "$ROOT/install.sh" "ADTENTION_REF"
assert_contains "$ROOT/install.ps1" "ADTENTION_REF"
...
assert_contains "$ROOT/.github/workflows/release.yml" "release_tag="
